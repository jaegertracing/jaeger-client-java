...
package io.jaegertracing.internal.reporters.protocols;
...
public class JaegerThriftSpanConverterTest {
  ...
  public void testConvertSpan() {
    ...
    io.jaegertracing.thriftjava.Span thriftSpan = JaegerThriftSpanConverter
  ...
  public void testConvertSpanOneReferenceChildOf() {
    ...
    io.jaegertracing.thriftjava.Span span = JaegerThriftSpanConverter
        .convertSpan((io.jaegertracing.internal.Span) child);

    assertEquals(((SpanContext)child.context()).getParentId(), span.getParentSpanId());
