...
public class TracedExecutorServiceTest {
  ...
  public void setUp() {
    ...
    tracedExecutorService = new TracedExecutorService(wrappedExecutorService, tracer);
  ...
  public void testSubmitCallableOfT() {
    ...
    verifyNoMoreInteractions(wrappedExecutorService, wrappedCallable, tracer);
  }
  ...
  public void testSubmitRunnable() {
    ...
    verifyNoMoreInteractions(wrappedExecutorService, wrappedRunnable, tracer);
  }
  ...
  public void testInvokeAll() throws Exception {
    ...
    verify(tracer, times(callableList.size())).activeSpan();
    verifyNoMoreInteractions(wrappedExecutorService, tracer);
  }
